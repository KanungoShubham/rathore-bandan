...
<div class="col-md-3 mb-5">
    <div class="cards" style="width: 260px;">
        <div class="image-container">
            <img src="<?php $imgs = $rw->profileimage; 
if ($imgs) {echo base_url().''.$rw->profileimage;} else {echo base_url().'assets/images/logos/rathore.png';}?>"
                class="himag"
            />
        </div>
        <div class="product-detail-container p-2">
            <div class="justify-content-between align-items-center">
                <div>
                    <h5 class="text-dark mb-2">
                        <b> Name:<?php echo $rw->socialname; ?> </b>
                    </h5>
                </div>
            ...
            <center><a href="<?php echo base_url()?>SocialDetail/<?php echo $rw->id ?>" class="btn btn-info btn-sm" target="_blank">view More </a></center>
        </div>
    </div>
</div>
