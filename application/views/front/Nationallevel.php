...
if ($imgs) {echo base_url().''.$rw->officeimage;} else {echo base_url().'assets/images/logos/rathore.png';}?>"
        ...
        <div class="product-detail-container p-2">
            <div class="justify-content-between align-items-center" style="height: 99px;">
                <div>
            ...
            <center><a href="<?php echo base_url()?>NationalDetail/<?php echo $rw->id ?>" class="btn btn-info btn-sm" target="_blank">view More </a></center>
        </div>
    </div>
</div>
