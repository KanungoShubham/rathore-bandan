...
<form enctype="multipart/form-data"  method="POST" class="forms-sample"   id="officeform">
                  ...
                  <div class="form-group ">
                     ...
                     <div class="form-group col-lg-12">
                        <input type="button" value="+" class="btn btn-primary add ">
                                ...
                                <input type="file" class="form-control" id="inputGroupFile04" class="form-control" name="officeimage">
   ...
   $('#officeform').submit(function(e){
            ...
            $.ajax({
             url:'<?php echo base_url();?>State/addoffice',
             type:"POST",
            dataType: "json",
