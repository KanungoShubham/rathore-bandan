<div class="main-panel">
   ...
   <form id="updateofiiceinfo" method="POST" enctype="multipart/form-data" >  
            ...
            <input type="text" name="upimgup"  multiple="true" value="<?php echo $rw ['profileimage'];?>">
            </div>
            <div class="form-group">
                      <label for="exampleInputName1">office Name</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="upofficename" required="required" value="<?php echo $rw ['socialname']; ?>">
                    </div>
            
                    <div class="form-group">
               <label>Office Description</label>
   <textarea class="form-control" name="socialdec" id="input-4" required="required"><?php echo $rw['socialdec']; ?></textarea>
                    ...
                    <input type="email"name="officehemail[]" class="form-control mb-3"  placeholder="Enter Email Id" value="<?php echo $Email [$i]; ?>">
                     ...
                     <div class="form-group col-lg-12">
                        <input type="button" value="+" class="btn btn-primary add ">
                                    ...
                                    <input type="text"  name="upofficefacebook" placeholder="Facebook Page Link"  class="form-control"  value="<?php echo $rw['socialfacebook']; ?>" >
                                        
                                    </div>
                                    <div class="form-group">
                                        <label> Instagram Page Link: <span>*</span></label>
                              <input type="text"  name="upofficeinstagram" placeholder="Instagram Page Link"  class="form-control"  value="<?php echo $rw['socialinstagram']; ?>">
...
<script>
   $('#updateofiiceinfo').submit(function(e){
            ...
            $.ajax({
             url:'<?php echo base_url();?>Socialgroups/officeupdate',
             type:"POST",
            dataType: "json",
             ...
             async:false,
              success: function(data){
                 ...
                 if(data['error'] == 0){
                  ...
                  document.getElementById("updateofiiceinfo").reset();
