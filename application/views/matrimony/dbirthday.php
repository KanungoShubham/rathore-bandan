...
<div class="form-group  ">
    ...
    <input id="eventname" class="form-control" type="text" name="birthdayname" required />
</div>
</div>
    ...
    <div class="form-group  ">
        ...
        <input id="bimage" class="form-control" type="file" name="bimage"  accept="image/png, image/gif,image/jpeg,image/jpg" required />
...
<script type="text/javascript" >
  ...
  $('#binfo').submit(function(e){
    ...
    CKEDITOR.instances[business].updateElement();
     $.ajax({
             url:'<?php echo base_url();?>Matrimony/addbirthday/',
             type:"POST",
            dataType: "json",
