<style>
    .bc{
        background: linear-gradient(rgba(0, 0, 0, 0.6),rgba(0, 0, 0, 0.6)),url(<?php echo base_url().'assets/condolenceimages/dod.webp';?>);
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <?php  foreach ($condolencelist as $rw) {  ?>
                                ...
                                <div class="my-auto mx-auto">
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <center>
                                                ...
                                                <a href="<?php echo base_url()?>updatcondolence/<?php echo $rw->id ?>" class="hosmbe  btn btn-info btn-sm " >
                                                    Update condolence
                                                </a>
                                            </center>
                                        </div>
