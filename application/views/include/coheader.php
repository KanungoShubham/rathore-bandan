        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Hospice</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
             <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>Hospiceform">Hospice From</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>dashbored">Add Members</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>donation">Add Donation</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basics" aria-expanded="false" aria-controls="ui-basics">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title"> State Community</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basics">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>sataoffice">State Office</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>satemaber">Add Members</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basics" aria-expanded="false" aria-controls="ui-basics">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title"> National Community</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basics">
              <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>nationaloffice">National Office</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>nationalmaber">Add Members</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basics" aria-expanded="false" aria-controls="ui-basics">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title"> journalist New Paper</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basics">
              <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>newpaperoffice">Add Office</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>newspaperoffice">Add Members</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basics" aria-expanded="false" aria-controls="ui-basics">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title"> Social Groups</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basics">
              <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>socialgroup">Add Groups</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>socialmember">Add Members</a></li>
